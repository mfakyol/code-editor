...
vi.mock('@/services/pen.service', () => ({
  default: { publicList: vi.fn() },
}))
...
const mockedList = vi.mocked(penService.publicList)
...
describe('Explore page', () => {
  ...
  it('refetches with popular sort when the toggle is clicked', async () => {
    ...
    await waitFor(() => expect(mockedList).toHaveBeenLastCalledWith('popular'))
  })
